...
# For bz#1243691 - 
Patch344: kvm-ide-Check-array-bounds-before-writing-to-io_buffer-C.patch
# For bz#1243691 - 
Patch345: kvm-ide-atapi-Fix-START-STOP-UNIT-command-completion.patch
# For bz#1243691 - 
Patch346: kvm-ide-Clear-DRQ-after-handling-all-expected-accesses.patch
# For bz#1243727 - CVE-2015-3214 qemu-kvm-rhev: qemu/kvm: i8254: out-of-bounds memory access in pit_ioport_read function [rhel-7.1.z]
Patch347: kvm-i8254-fix-out-of-bounds-memory-access-in-pit_ioport_.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch348: kvm-rtl8139-avoid-nested-ifs-in-IP-header-parsing-CVE-20.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch349: kvm-rtl8139-drop-tautologous-if-ip-.-statement-CVE-2015-.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch350: kvm-rtl8139-skip-offload-on-short-Ethernet-IP-header-CVE.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch351: kvm-rtl8139-check-IP-Header-Length-field-CVE-2015-5165.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch352: kvm-rtl8139-check-IP-Total-Length-field-CVE-2015-5165.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch353: kvm-rtl8139-skip-offload-on-short-TCP-header-CVE-2015-51.patch
# For bz#1248767 - EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z]
Patch354: kvm-rtl8139-check-TCP-Data-Offset-field-CVE-2015-5165.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch355: kvm-qemu_ram_foreach_block-pass-up-error-value-and-down-.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch356: kvm-rdma-Fix-qemu-crash-when-IPv6-address-is-used-for-mi.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch357: kvm-Rename-RDMA-structures-to-make-destination-clear.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch358: kvm-Remove-unneeded-memset.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch359: kvm-Store-block-name-in-local-blocks-structure.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch360: kvm-Translate-offsets-to-destination-address-space.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch361: kvm-Rework-ram_control_load_hook-to-hook-during-block-lo.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch362: kvm-Allow-rdma_delete_block-to-work-without-the-hash.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch363: kvm-Rework-ram-block-hash.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch364: kvm-Sort-destination-RAMBlocks-to-be-the-same-as-the-sou.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch365: kvm-Sanity-check-RDMA-remote-data.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch366: kvm-Fail-more-cleanly-in-mismatched-RAM-cases.patch
# For bz#1248382 - migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!
Patch367: kvm-RDMA-Fix-error-exits.patch
...
Patch372: 0004-sheepdog-selectable-object-size-support.patch
Patch373: 0005-sheepdog-fix-confused-return-values.patch
Patch374: 0006-sheepdog-serialize-requests-to-overwrapping-area.patch
Patch375: 0007-sheepdog-add-reopen-support.patch
Patch376: 0008-sheepdog-use-per-AIOCB-dirty-indexes-for-non-overlap.patch
Patch377: 0009-sheepdog-refine-discard-support.patch
...
%changelog
* Fri Aug 28 2015 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.1.2-23.el7_1.9
- kvm-vnc-fix-memory-corruption-CVE-2015-5225.patch [bz#1255897]
- Resolves: bz#1255897
  (CVE-2015-5225 qemu-kvm-rhev: Qemu: ui: vnc: heap memory corruption in vnc_refresh_server_surface [rhel-7.1.z])

* Thu Aug 06 2015 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.1.2-23.el7_1.8
- kvm-qemu_ram_foreach_block-pass-up-error-value-and-down-.patch [bz#1248382]
- kvm-rdma-Fix-qemu-crash-when-IPv6-address-is-used-for-mi.patch [bz#1248382]
- kvm-Rename-RDMA-structures-to-make-destination-clear.patch [bz#1248382]
- kvm-Remove-unneeded-memset.patch [bz#1248382]
- kvm-Store-block-name-in-local-blocks-structure.patch [bz#1248382]
- kvm-Translate-offsets-to-destination-address-space.patch [bz#1248382]
- kvm-Rework-ram_control_load_hook-to-hook-during-block-lo.patch [bz#1248382]
- kvm-Allow-rdma_delete_block-to-work-without-the-hash.patch [bz#1248382]
- kvm-Rework-ram-block-hash.patch [bz#1248382]
- kvm-Sort-destination-RAMBlocks-to-be-the-same-as-the-sou.patch [bz#1248382]
- kvm-Sanity-check-RDMA-remote-data.patch [bz#1248382]
- kvm-Fail-more-cleanly-in-mismatched-RAM-cases.patch [bz#1248382]
- kvm-RDMA-Fix-error-exits.patch [bz#1248382]
- Resolves: bz#1248382
  (migration/rdma: 7.1->7.2: RDMA ERROR: ram blocks mismatch #3!)

* Mon Aug 03 2015 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.1.2-23.el7_1.7
- kvm-rtl8139-avoid-nested-ifs-in-IP-header-parsing-CVE-20.patch [bz#1248767]
- kvm-rtl8139-drop-tautologous-if-ip-.-statement-CVE-2015-.patch [bz#1248767]
- kvm-rtl8139-skip-offload-on-short-Ethernet-IP-header-CVE.patch [bz#1248767]
- kvm-rtl8139-check-IP-Header-Length-field-CVE-2015-5165.patch [bz#1248767]
- kvm-rtl8139-check-IP-Total-Length-field-CVE-2015-5165.patch [bz#1248767]
- kvm-rtl8139-skip-offload-on-short-TCP-header-CVE-2015-51.patch [bz#1248767]
- kvm-rtl8139-check-TCP-Data-Offset-field-CVE-2015-5165.patch [bz#1248767]
- Resolves: bz#1248767
  (EMBARGOED CVE-2015-5165 qemu-kvm-rhev: Qemu: rtl8139 uninitialized heap memory information leakage to guest [rhel-7.1.z])

* Mon Jul 20 2015 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.1.2-23.el7_1.6
- kvm-i8254-fix-out-of-bounds-memory-access-in-pit_ioport_.patch [bz#1243727]
- Resolves: bz#1243727
  (CVE-2015-3214 qemu-kvm-rhev: qemu/kvm: i8254: out-of-bounds memory access in pit_ioport_read function [rhel-7.1.z])

* Fri Jul 17 2015 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.1.2-23.el7_1.5
- kvm-ide-Check-array-bounds-before-writing-to-io_buffer-C.patch [bz#1243691]
- kvm-ide-atapi-Fix-START-STOP-UNIT-command-completion.patch [bz#1243691]
- kvm-ide-Clear-DRQ-after-handling-all-expected-accesses.patch [bz#1243691]
- Resolves: bz#1243691
  ()
